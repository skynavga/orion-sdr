...
#[test]
fn throughput_qam16_roundtrip() {
    throughput_qam_roundtrip::<4>("QAM-16");
}

#[test]
fn throughput_qam64_roundtrip() {
    throughput_qam_roundtrip::<6>("QAM-64");
}

#[test]
fn throughput_qam256_roundtrip() {
    throughput_qam_roundtrip::<8>("QAM-256");
}
