...
pub const VARICODE_MAX_BITS: usize = 11;
...
const VARICODE: [(u16, u8); 128] = [
    ...
    (0b11100111111,   11), //  9  HT
    (0b11101111111,   11), // 10  LF
    (0b11111011111,   11), // 11  VT
    (0b11111110111,   11), // 12  FF
    (0b11111111011,   11), // 13  CR
    (0b11111111101,   11), // 14  SO
    (0b11111111111,   11), // 15  SI
    (0b10110111111,   11), // 16  DLE
    (0b10111111101,   11), // 17  DC1
    (0b10111111111,   11), // 18  DC2
    (0b11101101111,   11), // 19  DC3
    (0b11101111011,   11), // 20  DC4
    (0b11110101111,   11), // 21  NAK
    (0b11110111101,   11), // 22  SYN
    (0b11111101011,   11), // 23  ETB
    (0b11111101101,   11), // 24  CAN
    (0b11111110101,   11), // 25  EM
    (0b11111110111,   11), // 26  SUB
    (0b11111111111,   11), // 27  ESC  (same as SI — placeholder)
    (0b11011111111,   11), // 28  FS
    (0b11101011111,   11), // 29  GS
    (0b11110101101,   11), // 30  RS
    (0b11110110111,   11), // 31  US
    (0b1,              1), // 32  SP
    (0b111111111,      9), // 33  !
    (0b101011111,      9), // 34  "
    (0b111110101,      9), // 35  #
    ...
    (0b110101110,      9), // 90  Z
    (0b11101110111,   11), // 91  [
    (0b11110111011,   11), // 92  backslash
    (0b11110111111,   11), // 93  ]
    (0b1010111111,    10), // 94  ^
    (0b101110111111,  12), // 95  _
    (0b101010111111,  12), // 96  `
    (0b1011,           4), // 97  a
    (0b1011111,        7), // 98  b
    (0b101111,         6), // 99  c
    (0b101101,         6), // 100 d
    ...
    (0b1011101,        7), // 121 y
    (0b111010101,      9), // 122 z
    (0b10101101111,   11), // 123 {
    (0b10110111011,   11), // 124 |
    (0b10111011111,   11), // 125 }
    (0b1010101011,    10), // 126 ~
    (0b10110111111,   11), // 127 DEL
];
...
impl VaricodeDecoder {
    ...
    pub fn push_bit(&mut self, bit: u8) {
        ...
        if is_zero && self.prev_zero {
            ...
            if self.len < VARICODE_MAX_BITS as u8 {
                self.len += 1;
            }
