...
mod tests {
    ...
    fn ft8_codec_roundtrip_all_ones() {
        // 77 bits all-ones. Bits 0-76 span bytes 0-9; bits 72-76 live in byte 9 bits 7-3.
        // Bits 77-79 (byte 9 bits 2-0) are slack and must be zero.
        let mut payload: Ft8Bits = [0xFFu8; 10];
        payload[9] = 0xF8; // bits 72-76 set, bits 77-79 zero
        let frame = Ft8Codec::encode(&payload);
